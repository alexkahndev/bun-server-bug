export const Demo2 = () => {
  return (
    <article className="demo2">
      ...
      <p>
        Logo365.AI is an AI-powered platform that allows small
        businesses to automatically generate customized social
        media graphics for national observances. Celebrate
        relevant national days, weeks, and months with your
        audience, enhancing brand engagement and visibility on
      ...
      <div className='list'>
          <div className='list-item'>
            ...
            <span className='TextRegularNormal'>
              <span>
                Effortlessly celebrate national observances with
        ...
        <a href="/pricing" className="button white-button">Learn More</a>
        <a href="/login" className="button white-button">Sign Up</a>
      </section>     
